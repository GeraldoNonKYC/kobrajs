...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/kobrawalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { kobrawalletd } = gRPC.loadPackageDefinition(packageDefinition).kobrawalletd

    this._client = new kobrawalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
